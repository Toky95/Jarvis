...
class VoiceAssistantService : Service(), RecognitionListener {
    ...
    private fun traiterPhrase(phrase: String) {
        if (!phrase.contains(motCle)) return // le mot-clé n'a pas été entendu, on ignore
    ...
    private fun reveillerEcran() {
        ...
        // Ne fonctionne que si le téléphone n'a PAS de code/schéma/empreinte configuré.
        // Avec un vrai verrouillage sécurisé, Android bloque volontairement le contournement.
    ...
    // --- Callbacks RecognitionListener non utilisés mais requis ---
